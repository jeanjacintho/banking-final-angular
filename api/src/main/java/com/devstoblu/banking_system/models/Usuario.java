...
public class Usuario {
    ...
    public Usuario(Long id, String nomeCompleto, String cpf, String email, String telefone, LocalDate dataNascimento, String enderecoCompleto, String senha, Status status, Tipo tipo) {
        this.id = id;
